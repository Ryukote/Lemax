...
/// <summary>
/// Represents search hotels all query validator type.
/// </summary>
public class SearchHotelsAllQueryValidator : AbstractValidator<SearchHotelsAllQuery>
{
    ...
    public SearchHotelsAllQueryValidator()
    {
